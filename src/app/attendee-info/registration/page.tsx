    ...
    <div className="w-full">
      ...
      <SectionWrapper>
        <SectionContent>
          ...
          <p>
            Register by clicking on the <b>Member Login</b> button in the <a href="https://www.ucea.org/" target="_blank" className="text-blue-700 underline">ucea homepage</a> upper right corner or direct <a target="_blank" className="text-blue-700 underline" href="https://www.viethconsulting.com/members/mlogin.php?org_id=UCEA">Member Login Link Here</a>. If you are unable to log in to your member profile page, please email
