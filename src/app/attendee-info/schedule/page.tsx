...
const schedule = [
  ...
  },
  {
    ...
    events: [
      ...
      "9:20 – 10:30 a.m. | General Session IV",
            ...
            <div key={index} className="mb-10">
              ...
              <ul className="space-y-2">
                {day.events.map((event, idx) => (
                  <li key={idx} className="text-base md:text-lg text-gray-800 pl-2 relative before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-2 before:h-2 before:rounded-full before:bg-blue-600 before:-translate-x-4">
                    {event}
                  </li>
                ))}
              </ul>
